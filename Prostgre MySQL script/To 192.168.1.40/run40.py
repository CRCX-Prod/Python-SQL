...
postQuery = """Select
  ...
  COALESCE((SELECT option_title FROM cos_mview_dropdown_radio_values WHERE form_id = 90 AND field_id = '145' AND option_id = b_sites.data->>'region'), '') as "Region",
  b_sites.data->>'team' as "Team" ,
  b_sites.data->>'o_m_vendor' as "O&M Vendor" ,
